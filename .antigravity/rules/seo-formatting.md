...
2. **Đoạn văn (Paragraphs):**
   ...
   - Mỗi câu không nên vượt quá 30 từ để đảm bảo dễ đọc trên thiết bị di động.
...
4. **Danh sách (Lists):**
   ...
   - Đối với các nhãn in đậm (bold labels) ở đầu mục danh sách, bắt buộc sử dụng dấu hai chấm `:` thay vì dấu chấm `.` làm ký tự phân tách (Ví dụ: `* **Nhãn**: Nội dung`).
