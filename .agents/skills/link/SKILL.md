...
4. **Ưu tiên URL có traffic thực (nếu có GSC data):** Khi có nhiều link candidate tương đương về chủ đề, kiểm tra `knowledge/3-pipeline/gsc-opportunities.md` section "Backfill Internal Link" và `knowledge/raw/gsc/pages.csv`. Ưu tiên URL có clicks cao hơn — trang đang nhận traffic thực truyền authority mạnh hơn trang static. Nếu file GSC không tồn tại, bỏ qua bước này và chọn theo semantic relevance bình thường.
